...
public abstract class EaseFunction
{
	...
	public static readonly EaseFunction EaseQuarticInOut 
		= new PolynomialEase((x) => x < 0.5f ? 8f * x * x * x * x : -8f * x * x * x * x + 32f * x * x * x - 48f * x * x + 32f * x - 7f);
	...
	public static readonly EaseFunction EaseQuinticInOut 
		= new PolynomialEase((x) => x < 0.5f ? 16f * x * x * x * x * x : 16f * x * x * x * x * x - 80f * x * x * x * x + 160f * x * x * x - 160f * x * x + 80f * x - 15f);
	...
	public static readonly EaseFunction EaseCircularInOut 
		= new PolynomialEase((x) => x < 0.5f ? (1f - (float)Math.Sqrt(1.0 - Math.Pow(x * 2, 2))) * 0.5f : (float)((Math.Sqrt(1.0 - Math.Pow(-2 * x + 2, 2)) + 1) * 0.5));

	public static readonly EaseFunction EaseSine = new PolynomialEase((x) => (float)Math.Sin(x * MathHelper.Pi));
	...
	public static EaseFunction EaseOutBack(double maxValue = 1.70158)
	{
		...
		return new PolynomialEase((x) => (float)(1 + c3 * Math.Pow(x - 1, 3) + c1 * Math.Pow(x - 1, 2)));
	}

	public static EaseFunction EaseOutElastic(double maxValue = 2.09439) => new PolynomialEase((x) => x switch
	{
		0 => 0,
		1 => 1,
